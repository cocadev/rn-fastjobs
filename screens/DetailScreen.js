...
import { ScrollView, StyleSheet, Text, View, TouchableOpacity, Image, Dimensions, FlatList, TextInput, } from 'react-native';
import { i } from '../constants/Style';
import { Ionicons, MaterialCommunityIcons, EvilIcons, FontAwesome, Entypo } from "@expo/vector-icons";
    ...
    <TouchableOpacity style={{backgroundColor:Colors.WHITE, paddingLeft:10, marginTop:6  }}>
        ...
        <View style={{flexDirection:'row', paddingHorizontal:12, marginVertical:10,}}>
           ...
           <View style={{ flex:3, marginLeft:12}}>
             ...
             <Text style={{color:Colors.GREY1}}>{t("title:shared")} {item.createOn}</Text>
           </View>
    ...
    return (
      <ScrollView style={i.container}>
        ...
        <FlatList
          ...
          renderItem={this._renderItem(this.props.t)}
        />
...
export default withNamespaces(["common"], { wait: true })( DetailScreen );
